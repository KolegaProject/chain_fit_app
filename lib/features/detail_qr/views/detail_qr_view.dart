    ...
    return Container(
      ...
      child: const Column(
        ...
        children: [
          ...
          _TipItem(
            text:
                "QR Code ini bersifat rahasia dan memiliki batas waktu penggunaan.",
          ),
          SizedBox(height: 12),
          _TipItem(
            text:
                "Jika gagal, coba bersihkan layar atau tekan tombol Perbarui.",
          ),
        ],
      ),
    );
...
//             const SizedBox(height: 4),
//             Text(
//               _qrData?.memberId.isNotEmpty == true ? _qrData!.memberId : "—",
//               style: const TextStyle(
//                 fontSize: 18,
//                 fontWeight: FontWeight.w700,
//                 color: Color(0xFF4F5DFF),
...
//                 onPressed: _isLoading ? null : _fetchQrData,
//                 icon: const Icon(Icons.refresh_rounded, size: 18),
//                 label: Text(_isLoading ? "Memuat..." : "Perbarui Kode QR"),
//                 style: ElevatedButton.styleFrom(
//                   elevation: 0,
//                   backgroundColor: const Color(0xFFF4F4FF),
//                   foregroundColor: const Color(0xFF4F5DFF),
...
//     // 3) Data null / token kosong
//     if (_qrData == null || _qrData!.token.isEmpty) {
//       return SizedBox(
//         height: 240,
//         child: Column(
//           mainAxisAlignment: MainAxisAlignment.center,
